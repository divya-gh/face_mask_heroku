...
$(document).ready(function(){
    ...
    renderPredictedImage = (file) => {
                    ...
                    d3.json(`/get_image/${file}`).then((data) => { 
                        ...
                        // console.log("previous src",document.getElementById("predict_image").src)
                        // image_selector.attr("src" , `${data.Image_path}`)
                        document.getElementById("predict_image").src=data.Image_path;
                        // console.log("Current src",document.getElementById("predict_image").src)
